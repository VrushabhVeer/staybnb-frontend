...
const Hero = () => {
  return (
    <div className="w-11/12 mx-auto h-[100vh] md:h-[90vh] flex flex-col-reverse md:flex-col-reverse lg:flex-row xl:flex-row items-center justify-between gap-8 md:gap-20 mt-44 md:mt-0">
      <div className="w-full">
        <div className="flex items-center flex-row gap-3 text-sm md:text-base text-[#1f77fa]">
          {heroData.tags.map((tag, index) => (
            <p key={index}>{tag}</p>
          ))}
        </div>
        <h1 className="text-4xl md:text-6xl leading-snug md:leading-tight font-bold">
          {heroData.title}
        </h1>
        <p className="mt-5 text-gray-500">{heroData.description}</p>
      ...
      <div className="w-full relative">
        ...
        <div className="absolute top-20 md:top-10 left-5 md:left-10 p-3 bg-white bg-opacity-80 rounded-lg">
          <p className="text-sm md:text-base">Get discount up to</p>
        ...
        <div className="absolute bottom-32 md:bottom-20 left-10 md:left-20 p-3 bg-white bg-opacity-80 rounded-lg">
          <p className="text-sm md:text-base">New properties added</p>
          <div className="flex flex-row items-center gap-2">
            <p className="text-sm md:text-base">every week</p>
